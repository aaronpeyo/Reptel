...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <small>Gestion de categorias</small>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Tabla con todas las categorias</h3>
...
===================================================================-->
    ...
    <div class="container">
        ...
        <div class="row ">
      <p>    
          <a href="guardar_categoria.php" class="btn btn-success"> Nueva categoria </a>
      </p>
    </div>
       
        
         <?php
        $objeto = Categoria::recuperarTodos();
         if (count($objeto) > 0):
        ?>
         <div class="row">
            <table class="table table-hove">
              ...
              <tbody>  
                ...
                <tr class="warning"> 
                    ...
                    <td><a class="btn btn-primary" href="guardar_categoria.php?idCategoria=<?php echo $item['idCategoria'] ?>"> Actualizar</a></td>                   
                    <td> <a class="btn btn-danger btn-xs" href="eliminar_categoria.php?idCategoria=<?php echo $item['idCategoria'] ?>"> Borrar</a></td>     
                </tr>
                <?php endforeach;?>
              </tbody>  
            </table>
