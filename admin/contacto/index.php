...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <small>Gestion de contacto</small>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Gestion de contacto</li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Tabla con todos los mensajes</h3>
...
===================================================================-->
    ...
    <div class="container">
        ...
        <h2> Gestión de contacto </h2>
         ...
         <?php
        $objeto = Contacto::recuperarTodos();
         if (count($objeto) > 0):
        ?>
         <div class="row">
            <table class="table table-hove">
              ...
              <tbody>  
                ...
                <tr class="warning"> 
                    ...
                    <td> <a class="btn btn-danger btn-xs" href="eliminar_contacto.php?idContacto=<?php echo $item['idContacto'] ?>"> Borrar</a></td>     
                </tr>
                <?php endforeach;?>
              </tbody>  
            </table>
