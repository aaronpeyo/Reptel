    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Tabla con todos los comentarios</h3>
...
===================================================================-->
 ...
 <section>
    <div class="container">
        ...
        <div class="row ">
      <p>    
          <a href="guardar_comentario.php" class="btn btn-success"> Nuevo comentario </a>
      </p>
    </div>
            ...
            <table class="table table-hove">
              ...
              <tbody>  
                ...
                <tr class="warning"> 
                    ...
                    <td><a class="btn btn-primary" href="guardar_comentario.php?idComentario=<?php echo $item['idComentario'] ?>"> Actualizar</a></td>                   
                    <td> <a class="btn btn-danger btn-xs" href="eliminar_comentario.php?idComentario=<?php echo $item['idComentario'] ?>"> Borrar</a></td>     
                </tr>
                <?php endforeach;?>
              </tbody>  
            </table>
