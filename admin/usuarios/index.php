            ...
            <table class="table table-hove">
              ...
              <tbody>  
                ...
                <tr class="warning"> 
                    ...
                    <td><a class="btn btn-primary" href="guardar_usuario.php?idUsuario=<?php echo $item['idUsuario'] ?>"> Actualizar</a></td>                   
                    <td> <a class="btn btn-danger btn-xs" href="eliminar_usuario.php?idUsuario=<?php echo $item['idUsuario'] ?>"> Borrar</a></td>     
                </tr>
                <?php endforeach;?>
              </tbody>  
            </table>
